...
<div id="revell">
	<div class="log">
<h2 style="color: black">Acadian Die Cast Model</h2>
<div class="logi">
	<h1 style="color: white">Price:US $78.9</h1>
	<br>
	<br>
	<br>
...
<div class="rn">
	...
	<br>
	<li style="color: blue">Manufactured By Canada At First</li>
	<br>
