...
<br>
<h3 style="color: white">Fig : Alfa Romeo GTF4</h3>
<br>
<br> 
</div>
...
<div id="revell">
	<div class="log">
<h2>Alfa Romeo GTF4 Cast Model</h2>
<div class="logi">
	<h1>Price:US $179.9</h1>
	<br>
	<br>
	<br>
...
<div class="rn">
	<ul>
	<li>designed by gola andrenoail </li>
	<br>
	<li style="color: blue">Manufactured By UK At First</li>
	<br>
