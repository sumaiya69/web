...
<br>
<h3 style="color: white">Fig : Rolls Royce67USA</h3>
<br>
<br> 
</div>
...
<div id="revell">
	<div class="log">
<h2 style="color: black">Rolls Royce67USA427 Die Cast Model</h2>
<div class="logi">
	<h1 style="color: white">Price:US $110.00</h1>
	<br>
	<br>
	<br>
...
<div class="rn">
	<ul>
	<li>Designed By Sir mackgonahul majkani</li>
	<br>
	<li style="color: blue">Manufactured By USA At First</li>
	<br>
